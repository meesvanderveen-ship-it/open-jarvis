...
from bot.phase_d6_cost_aware_split_baseline import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="D.6 research-only cost-aware split baseline report using local cached/fixture candles. No Coinbase calls."
    )
...
def main() -> int:
    ...
    if args.output:
        write_cost_aware_split_baseline_report(report, args.output)
