...
from bot.phase_d6_cost_assumptions import list_cost_scenarios  # noqa: E402
from bot.phase_d6_level0_signal_backtest import (  # noqa: E402
    SIGNAL_NAME,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="D.6 research-only fixed Level-0 signal backtest scaffold using local cached/fixture candles. No Coinbase calls."
    )
    parser.add_argument("--candles", required=True, help="Local normalized D.6 candle JSON path")
    parser.add_argument("--signal", choices=[SIGNAL_NAME], default=SIGNAL_NAME)
    parser.add_argument("--cost-scenario", choices=list_cost_scenarios(), default="standard_fee_only")
...
def main() -> int:
    ...
    if args.output:
        write_level0_signal_backtest_report(report, args.output)
