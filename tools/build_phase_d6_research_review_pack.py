...
from bot.phase_d6_research_review_pack import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="D.6 research-only review/evidence pack from local cached/fixture candles. No Coinbase calls."
    )
    ...
    parser.add_argument("--output", default="", help="Optional JSON review-pack output path")
...
def main() -> int:
    ...
    if args.output:
        write_json_review_pack(pack, args.output)
    if args.markdown_output:
        write_markdown_review_pack(pack, args.markdown_output)
