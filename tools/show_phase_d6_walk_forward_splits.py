...
from bot.phase_d6_walk_forward_splits import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="D.6 research-only walk-forward split scaffold using local cached/fixture candles. No Coinbase calls."
    )
...
def main() -> int:
    ...
    if args.output:
        write_walk_forward_split_report(report, args.output)
