...
from bot.phase_d6_level0_signal_backtest import SIGNAL_NAME  # noqa: E402
from bot.phase_d6_level0_signal_bundle import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="D.6 research-only Level-0 signal report bundle from local cached/fixture candles. No Coinbase calls."
    )
