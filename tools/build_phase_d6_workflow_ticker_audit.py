...
from bot.phase_d6_workflow_ticker_audit import build_phase_d6_workflow_ticker_audit  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Report-only full workflow and multi-ticker coverage audit. No Coinbase/OpenAI calls."
    )
...
def main() -> int:
    ...
    audit = build_phase_d6_workflow_ticker_audit(
    ...
    report = build_phase_d6_report_bundle(
        report_type="d6_workflow_ticker_coverage_audit",
        content=audit,
